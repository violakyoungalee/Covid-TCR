...
write.table(clonedf, "su_cd8_gliph2_clones_all.txt", quote = F, row.names = F, col.names = F, sep = "\t")
write.table(clonedf[grep("HD", clonedf$cond),], "su_cd8_gliph2_clones_hd.txt", quote = F, row.names = F, col.names = F, sep = "\t")
write.table(clonedf[grep("mild", clonedf$cond),], "su_cd8_gliph2_clones_mild.txt", quote = F, row.names = F, col.names = F, sep = "\t")
write.table(clonedf[grep("moderate", clonedf$cond),], "su_cd8_gliph2_clones_moderate.txt", quote = F, row.names = F, col.names = F, sep = "\t")
write.table(clonedf[grep("severe", clonedf$cond),], "su_cd8_gliph2_clones_severe.txt", quote = F, row.names = F, col.names = F, sep = "\t")
