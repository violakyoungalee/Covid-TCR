...
write.table(volcano.pw, paste0("dex/su_cd4_volcano_",kmersize,"_",expid,".csv"), quote = F, row.names = F, col.names = T, sep = ",")
...
pdf(paste0("dex/su_cd4_volcano_",kmersize,"_",expid,".pdf"), width = 10, height = 6)
plt
dev.off()
